...
export const skills = {
  ...
  categories: {
    "Languages": ["TypeScript", "Python", "JavaScript", "R", "Go", "Swift", "Ruby", "Rust", "C#", "C++", "SQL"],
    ...
    "Databases": ["MySQL", "PostgreSQL", "MongoDB", "Snowflake", "Supabase", "Firebase"],
    "Tools": [ "Vim", "Git", "Figma", "Postman", "JIRA", "Airflow", "VS Code"],
  },
};
